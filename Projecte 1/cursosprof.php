...
<body>
    ...
    $nom = $_SESSION['nom'];
    // $sql = "SELECT * FROM cursos WHERE data_inici>'$data_actual' and actiu = 1 and codi_curs NOT IN (SELECT codi_curs FROM matricula)";
            ...
            echo "</form>";
                ...
                $linies = mysqli_num_rows($consulta);
                    ...
                    for($i = 0; $i < $linies; $i++){
                        ...
                        echo "<td>"."<a href='alumnescurs.php'><input type='button' name='Alumnes' value='alumnes'></a>"."</td>";
                        echo "</tr>";
                    }
                echo "</table>";
                ?>    
