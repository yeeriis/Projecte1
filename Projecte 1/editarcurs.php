            ...
            if ($_REQUEST['codi_curs']) {
                ...
                if ($conexio == false){
                    ...
                    if(!$consulta){ 
                        ...
                        echo "<br>";
                        echo "<br>";
                        echo "Codi_curs: <input type='text' name='codi_curs' id='codi_curs' value='".$curs['codi_curs']."' readonly>";
                        echo "<br>";
                        echo "<br>";
                        echo "Nom: <input type='text' name='nom' id='nom' value='".$curs['nom']."'>";
                        echo "<br>";
                        echo "<br>";
                        echo "Descripcio: <input type='text' name='descripcio' id='descripcio' value='".$curs['descripcio']."'>";
                        echo "<br>";
                        echo "<br>";
                        echo "Hores: <input type='text' name='hores' id='hores' value='".$curs['hores']."'>";
                        echo "<br>";
                        echo "<br>";
                        echo "Data Inici: <input type='text' name='data_inici' id='data_final' value='".$curs['data_inici']."'>";
                        echo "<br>";
                        echo "<br>";
                        echo "Data Final: <input type='text' name='data_final' id='data_final' value='".$curs['data_final']."'>";
                        echo "<br>";
                        echo "<br>";
                        echo "DNI Professor: <input type='text' name='dni_professor' id='dni_professor' value='".$curs['dni_professor']."'>";
                        echo "<br>";
                        echo "<br>";
