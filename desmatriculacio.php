       ...
       if ($_REQUEST['dni']){
           if ($conexio == false){
               mysqli_connect_error();
                ...
                $dni = $_REQUEST['dni'];
                $sql = "DELETE FROM matricula WHERE codi_curs LIKE '$codi_curs' and dni_alumne LIKE '$dni'";
                ...
                if(!$consulta){
                   ...
                   echo "<h2>Desmatriculat correctament</h2>";
                   echo "<p>Redirigint...</p>";
        ...
        echo "Has d'estar validat per veure aquesta pàgina";    
    }
    ?>
</body>
</html>
